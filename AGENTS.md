...
## 5. Workspace Auto-Skills & Hooks

- **Semgrep Static Analysis**: Run localized security checks after files are modified to catch vulnerabilities and secrets.
- **Dependency Vetting**: Audit all packages with `npx autoskills` to maintain supply chain security.
